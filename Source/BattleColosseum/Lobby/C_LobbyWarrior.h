...
#include "C_LobbyWarrior.generated.h"

/**
 * 
 */
UCLASS()
class BATTLECOLOSSEUM_API AC_LobbyWarrior : public AC_BaseCharacter
{
	GENERATED_BODY()
...
public: // 변수
	...
	class USkeletalMesh* SM_Man;
	class USkeletalMesh* SM_Woman;
